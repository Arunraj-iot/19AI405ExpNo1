...
```
### OUTPUT:
<img width="730" height="377" alt="Screenshot 2026-02-06 134251" src="https://github.com/user-attachments/assets/973db46b-f0f7-437a-96b7-c8a617de204a" />

### RESULT:
```
The AI agent successfully treated unhealthy patients using the PEAS description.
```
